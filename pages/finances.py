...
bajance_display = st.empty()
balance_display.text('Your current bank balance is: £' ,st.session_state.balance)
...
if st.button('Add Money'):
  ...
  st.success('You added ', amount, ' to your account!')
  balance_display.text('Your current bank balance is: £', st.session_state.balance)
  
if st.button('Withdraw Money'):
  amount = st.number_input('Enter Amount')
  st.session_state.balance -= amount
  st.success('You withdrew ', amount, ' from your account!')
  balance_display.text('Your current bank balance is: £', st.session_state.balance)
